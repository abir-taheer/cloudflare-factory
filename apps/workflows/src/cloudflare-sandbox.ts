...
export const optionalCloudflareSandboxLayer = (bindings: CloudflareSandboxBindings, sandboxId: string) => {
  if (bindings.SANDBOX === undefined) return unavailableSandboxLayer;
