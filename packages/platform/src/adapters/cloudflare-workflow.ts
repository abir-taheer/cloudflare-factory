...
import { Workflow, type BackgroundJob } from "../capability-services.js";
...
export const cloudflareWorkflowLayer = (binding: CloudflareWorkflow<BackgroundJob>) => Layer.succeed(Workflow, Workflow.of({
