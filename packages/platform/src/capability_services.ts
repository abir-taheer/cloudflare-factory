...
import type { CapabilityError } from "./capability_error.js";
import type { CapabilityUnavailable } from "./capability_unavailable.js";

/** Provider failure; operation and cause preserve diagnostics without claiming success. */
export { CapabilityError } from "./capability_error.js";
/** Missing optional capability fails explicitly at use time. */
export { CapabilityUnavailable } from "./capability_unavailable.js";
...
/** Command runs exclusively in an external sandbox provider. */
