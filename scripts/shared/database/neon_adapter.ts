import { createNeonEmptyBranch, neonOwnerAnnotations } from "./neon_branch.ts";
import { randomUUID } from "node:crypto";
import { Effect } from "effect";
import { PreviewFailure, previewRecord, previewString } from "../../preview/preview_model.ts";
import { parseDatabaseHandoff } from "./database_contract.ts";
import type { DatabaseIdentity } from "./database_schema.ts";
import {
...
import type { DatabaseTarget, PreviewDatabaseAdapter } from "./database_adapter.ts";
