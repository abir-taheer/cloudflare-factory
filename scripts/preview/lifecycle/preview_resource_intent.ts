import { provisionPreviewHyperdrive } from "../cloudflare/preview_hyperdrive.ts";
import { Effect } from "effect";
import { PreviewFailure } from "../preview_model.ts";
import type { PreviewManifest, PreviewResource } from "../preview_model.ts";
import type { PreviewCloudflare } from "../cloudflare/preview_cloudflare.ts";
...
export function provisionPreviewDataResources(
  ...
  return Effect.gen(function* () {
    yield* provisionPreviewHyperdrive(manifest, cf, state, artifactRoot);
